...
test("renders the official v8 monogram without releasing production assets", async () => {
  ...
  assert.match(html, /Marca oficial aprovada/);
  ...
  assert.doesNotMatch(brandSource, /M5 18C12 10 22 9 30 15/);
});
